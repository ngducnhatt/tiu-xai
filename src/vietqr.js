...
export function vietqrUrlVND({ amountVND, description }) {
  const base = `https://img.vietqr.io/image/${encodeURIComponent(CFG.vietqr.bankId)}-${encodeURIComponent(CFG.vietqr.accountNo)}-${encodeURIComponent(CFG.vietqr.template)}.png`;
